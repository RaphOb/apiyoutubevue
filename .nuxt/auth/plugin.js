...
export default function (ctx, inject) {
  ...
  // local
  $auth.registerStrategy('local', new scheme_3e2123be($auth, {"endpoints":{"login":{"url":"/auth","method":"post","propertyName":"data"},"logout":false,"user":{"url":"/videos","method":"get","propertyName":"data"}},"_name":"local"}))
